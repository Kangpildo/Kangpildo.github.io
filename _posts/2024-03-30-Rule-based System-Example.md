...
이 프로젝트는 내가 자사의 제품 규칙을 관리하기 위해 Rule-based System을 만드는 것입니다. Durable Rules 라이브러리를 사용하여 다양한 제품 환경, 장비, 서비스 등에 대한 규칙을 정의하고 구현했습니다.
...
![규칙 정리 예시](assets/images/Rule-based.png)
자사의 
